...
<body>
    ...
    <%--
        *JSP를 이루는 구성
        ...
        2. 지시어 : jsp페이지 정보에대한 내용을 표현한다거나 또 다른페이지를 포함할때 사용하던
        ...
        3. 액션태그 : jsp페이지에서 어떤 동작을 하도록 지시하는 태그
            ...
            >> 커스텀액션태그 : jsp페이지에 바로사용 불가능(별도의 라이브러리 연동이 필요) 
                    -> 접두어에 jsp:이 아닌 모든 액션태그(가장많이 사용하는 라이브러리 jstl) 
    --%>
    
    <h3>*표준액션태그</h3>
    <a href="views/2_standard_action_tag/01_include.jsp">01_jsp:include</a>
    <a href="views/2_standard_action_tag/02_forward.jsp">01_jsp:forward</a>

    <h1>JSTL이란?</h1>
    <p>
        jsp에서 자주사용하는 기능들을 태그형태로 제공하는 표준 라이브러리(커스텀액션태그) <br>
    ...
    <a href="views/3_custom-action-tag/01_core.jsp">01_core</a>

    <h4>2. JSTL Formatting Library</h4>
    <p>숫자, 날짜및 시간 데이터의 출력형식을 지정할 때 사용</p>
    <a href="views/3_custom-action-tag/02_fmt.jsp">02_fmt</a>

    <h4>3. JSTL function Library</h4>
    <p>EL안에서 사용할 수 있는 메서드를 제공</p>
    <a href="views/3_custom-action-tag/03_function.jsp">03_function</a>
</body>
</html>